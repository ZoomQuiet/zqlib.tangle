#@+leo-ver=4-thin
#@+node:zoomq.20100414115206.4732:@shadow txt2tags.py
#@@language python
#@@tabwidth -4
#@<<txt2tags declarations>>
#@+node:zoomq.20100414115206.4733:<<txt2tags declarations>>
#!/usr/bin/env python
...
#@nl
#@<<base options>>
#@+node:zoomq.20100414115206.4896:<<base options>>
##############################################################################
...
#@nl
#@<<misc options>>
#@+node:zoomq.20100414115206.4895:<<misc options>>
...
#@nl
#@<<target's templates>>
#@+node:zoomq.20100414115206.4894:<<target's templates>>
##############################################################################
...
#@+others
#@+node:zoomq.20100414115206.4734:getTags
##############################################################################
...
#@-node:zoomq.20100414115206.4734:getTags
#@+node:zoomq.20100414115206.4735:getRules
##############################################################################
...
#@-node:zoomq.20100414115206.4735:getRules
#@+node:zoomq.20100414115206.4736:getRegexes
##############################################################################
...
def getRegexes():
    ...
    return bank
#@-node:zoomq.20100414115206.4736:getRegexes
#@+node:zoomq.20100414115206.4737:class error
...
class error(Exception):
    pass
#@-node:zoomq.20100414115206.4737:class error
#@+node:zoomq.20100414115206.4738:echo
def echo(msg):   # for quick debug
    print '\033[32;1m%s\033[m'%msg
#@-node:zoomq.20100414115206.4738:echo
#@+node:zoomq.20100414115206.4739:Quit
def Quit(msg=''):
    if msg: print msg
    sys.exit(0)
#@-node:zoomq.20100414115206.4739:Quit
#@+node:zoomq.20100414115206.4740:Error
def Error(msg):
    msg = _("%s: Error: ")%my_name + msg
    raise error, msg
#@-node:zoomq.20100414115206.4740:Error
#@+node:zoomq.20100414115206.4741:getTraceback
def getTraceback():
    try:
...
#@-node:zoomq.20100414115206.4741:getTraceback
#@+node:zoomq.20100414115206.4742:getUnknownErrorMessage
...
#@-node:zoomq.20100414115206.4744:Debug
#@+node:zoomq.20100414115206.4745:Readfile
def Readfile(file, remove_linebreaks=0, ignore_error=0):
    ...
    return data
#@-node:zoomq.20100414115206.4745:Readfile
#@+node:zoomq.20100414115206.4746:Savefile
...
#@-node:zoomq.20100414115206.4746:Savefile
#@+node:zoomq.20100414115206.4747:showdic
def showdic(dic):
    for k in dic.keys(): print "%15s : %s" % (k,dic[k])
#@-node:zoomq.20100414115206.4747:showdic
#@+node:zoomq.20100414115206.4748:dotted_spaces
def dotted_spaces(txt=''):
    return string.replace(txt,' ','.')

#@-node:zoomq.20100414115206.4748:dotted_spaces
#@+node:zoomq.20100414115206.4749:get_rc_path
...
#@-node:zoomq.20100414115206.4749:get_rc_path
#@+node:zoomq.20100414115206.4750:class CommandLine
##############################################################################
...
class CommandLine:
    ...
    """
    #@    @+others
    #@+node:zoomq.20100414115206.4751:__init__
    def __init__(self):
    ...
    #@-node:zoomq.20100414115206.4751:__init__
    #@+node:zoomq.20100414115206.4752:_compose_short_opts
    ...
    #@-node:zoomq.20100414115206.4752:_compose_short_opts
    #@+node:zoomq.20100414115206.4753:_compose_long_opts
    ...
    #@-node:zoomq.20100414115206.4753:_compose_long_opts
    #@+node:zoomq.20100414115206.4754:_tokenize
    ...
    #@-node:zoomq.20100414115206.4754:_tokenize
    #@+node:zoomq.20100414115206.4755:parse
    ...
    #@-node:zoomq.20100414115206.4755:parse
    #@+node:zoomq.20100414115206.4756:get_raw_config
    ...
    #@-node:zoomq.20100414115206.4756:get_raw_config
    #@+node:zoomq.20100414115206.4757:compose_cmdline
    ...
    #@-others
#@-node:zoomq.20100414115206.4750:class CommandLine
#@+node:zoomq.20100414115206.4758:class SourceDocument
##############################################################################
...
class SourceDocument:
    ...
    """
    #@    @+others
    #@+node:zoomq.20100414115206.4759:__init__
    ...
    #@-node:zoomq.20100414115206.4761:get
    #@+node:zoomq.20100414115206.4762:scan_file
    ...
    #@-node:zoomq.20100414115206.4762:scan_file
    #@+node:zoomq.20100414115206.4763:scan
    def scan(self, lines):
    ...
    #@-node:zoomq.20100414115206.4763:scan
    #@+node:zoomq.20100414115206.4764:get_raw_config
    ...
    #@-others
#@-node:zoomq.20100414115206.4758:class SourceDocument
#@+node:zoomq.20100414115206.4765:class ConfigMaster
##############################################################################
...
class ConfigMaster:
    ...
    """
    #@    @+others
    #@+node:zoomq.20100414115206.4766:__init__
    ...
    #@-node:zoomq.20100414115206.4766:__init__
    #@+node:zoomq.20100414115206.4767:_get_defaults
    ...
    #@-node:zoomq.20100414115206.4767:_get_defaults
    #@+node:zoomq.20100414115206.4768:_get_off
    def _get_off(self):
    ...
    #@-node:zoomq.20100414115206.4768:_get_off
    #@+node:zoomq.20100414115206.4769:_check_target
    ...
    #@-node:zoomq.20100414115206.4769:_check_target
    #@+node:zoomq.20100414115206.4770:get_target_raw
    ...
    #@-node:zoomq.20100414115206.4770:get_target_raw
    #@+node:zoomq.20100414115206.4771:add
    ...
    #@-node:zoomq.20100414115206.4771:add
    #@+node:zoomq.20100414115206.4772:get_outfile_name
    ...
    #@-node:zoomq.20100414115206.4772:get_outfile_name
    #@+node:zoomq.20100414115206.4773:sanity
    ...
    #@-node:zoomq.20100414115206.4773:sanity
    #@+node:zoomq.20100414115206.4774:parse
    def parse(self):
    ...
    #@-node:zoomq.20100414115206.4774:parse
    #@+node:zoomq.20100414115206.4775:find_value
    ...
    #@-others
#@-node:zoomq.20100414115206.4765:class ConfigMaster
#@+node:zoomq.20100414115206.4776:class ConfigLines
########################################################################
...
class ConfigLines:
    ...
    """
    #@    @+others
    #@+node:zoomq.20100414115206.4777:__init__
    ...
    #@-node:zoomq.20100414115206.4777:__init__
    #@+node:zoomq.20100414115206.4778:load_lines
    def load_lines(self):
    ...
    #@-node:zoomq.20100414115206.4778:load_lines
    #@+node:zoomq.20100414115206.4779:read_config_file
    ...
    #@-node:zoomq.20100414115206.4779:read_config_file
    #@+node:zoomq.20100414115206.4780:include_config_file
    ...
    #@-node:zoomq.20100414115206.4780:include_config_file
    #@+node:zoomq.20100414115206.4781:get_raw_config
    def get_raw_config(self):
    ...
    #@-node:zoomq.20100414115206.4781:get_raw_config
    #@+node:zoomq.20100414115206.4782:parse_line
    ...
    #@-others
#@-node:zoomq.20100414115206.4776:class ConfigLines
#@+node:zoomq.20100414115206.4783:class MaskMaster
##############################################################################

class MaskMaster:
    "(Un)Protect important structures from escaping and formatting"
    #@    @+others
    #@+node:zoomq.20100414115206.4784:__init__
    def __init__(self):
    ...
    #@-node:zoomq.20100414115206.4784:__init__
    #@+node:zoomq.20100414115206.4785:reset
    def reset(self):
        self.linkbank = []
        self.monobank = []
        self.macrobank = []
    ...
    #@-node:zoomq.20100414115206.4785:reset
    #@+node:zoomq.20100414115206.4786:mask
    def mask(self, line=''):
        global AUTOTOC
    ...
    #@-node:zoomq.20100414115206.4786:mask
    #@+node:zoomq.20100414115206.4787:undo
    def undo(self, line):
    ...
    #@-others
#@-node:zoomq.20100414115206.4783:class MaskMaster
#@+node:zoomq.20100414115206.4788:class TitleMaster
##############################################################################
import base64
#hashlib
...
class TitleMaster:
    "Title things"
    #@    @+others
    #@+node:zoomq.20100414115206.4789:__init__
    def __init__(self):
    ...
    #@-node:zoomq.20100414115206.4789:__init__
    #@+node:zoomq.20100414115206.4790:_open_close_blocks
    ...
    #@-node:zoomq.20100414115206.4790:_open_close_blocks
    #@+node:zoomq.20100414115206.4791:add
    def add(self, line):
    ...
    #@-node:zoomq.20100414115206.4791:add
    #@+node:zoomq.20100414115206.4792:close_all
    def close_all(self):
    ...
    #@-node:zoomq.20100414115206.4792:close_all
    #@+node:zoomq.20100414115206.4793:_save_toc_info
    def _save_toc_info(self):
        ...
        #print self.toc
    #@-node:zoomq.20100414115206.4793:_save_toc_info
    #@+node:zoomq.20100414115206.4794:_set_prop
    ...
    #@-node:zoomq.20100414115206.4794:_set_prop
    #@+node:zoomq.20100414115206.4795:_set_count_id
    ...
    #@-node:zoomq.20100414115206.4795:_set_count_id
    #@+node:zoomq.20100414115206.4796:_set_label
    def _set_label(self):
    ...
    #@-node:zoomq.20100414115206.4796:_set_label
    #@+node:zoomq.20100414115206.4797:_get_tagged_anchor
    ...
    #@-node:zoomq.20100414115206.4797:_get_tagged_anchor
    #@+node:zoomq.20100414115206.4798:_get_full_title_text
    ...
    #@-node:zoomq.20100414115206.4798:_get_full_title_text
    #@+node:zoomq.20100414115206.4799:get
    def get(self):
    ...
    #@-node:zoomq.20100414115206.4799:get
    #@+node:zoomq.20100414115206.4800:dump_marked_toc
    ...
    #@-others
#@-node:zoomq.20100414115206.4788:class TitleMaster
#@+node:zoomq.20100414115206.4801:class TableMaster
##############################################################################
...
class TableMaster:
    #@    @+others
    #@+node:zoomq.20100414115206.4802:__init__
    ...
    #@-node:zoomq.20100414115206.4802:__init__
    #@+node:zoomq.20100414115206.4803:_get_open_tag
    ...
    #@-node:zoomq.20100414115206.4803:_get_open_tag
    #@+node:zoomq.20100414115206.4804:_get_cell_align
    ...
    #@-node:zoomq.20100414115206.4804:_get_cell_align
    #@+node:zoomq.20100414115206.4805:_get_cell_span
    ...
    #@-node:zoomq.20100414115206.4805:_get_cell_span
    #@+node:zoomq.20100414115206.4806:_tag_cells
    ...
    #@-node:zoomq.20100414115206.4806:_tag_cells
    #@+node:zoomq.20100414115206.4807:add_row
    def add_row(self, cells):
        self.rows.append(cells)

    #@-node:zoomq.20100414115206.4807:add_row
    #@+node:zoomq.20100414115206.4808:parse_row
    ...
    #@-node:zoomq.20100414115206.4808:parse_row
    #@+node:zoomq.20100414115206.4809:dump
    def dump(self):
    ...
    #@-others
#@-node:zoomq.20100414115206.4801:class TableMaster
#@+node:zoomq.20100414115206.4810:class BlockMaster
##############################################################################
...
class BlockMaster:
    ...
    #@    @+others
    #@+node:zoomq.20100414115206.4811:__init__
    def __init__(self):
        self.BLK = []
        self.HLD = []
        self.PRP = []
    ...
    #@-node:zoomq.20100414115206.4811:__init__
    #@+node:zoomq.20100414115206.4812:block
    def block(self):
        if not self.BLK: return ''
        return self.BLK[-1]

    #@-node:zoomq.20100414115206.4812:block
    #@+node:zoomq.20100414115206.4813:isblock
    def isblock(self, name=''):
        return self.block() == name

    #@-node:zoomq.20100414115206.4813:isblock
    #@+node:zoomq.20100414115206.4814:prop
    def prop(self, key):
        if not self.PRP: return ''
        return self.PRP[-1].get(key) or ''

    #@-node:zoomq.20100414115206.4814:prop
    #@+node:zoomq.20100414115206.4815:propset
    ...
    #@-node:zoomq.20100414115206.4815:propset
    #@+node:zoomq.20100414115206.4816:hold
    def hold(self):
        if not self.HLD: return []
        return self.HLD[-1]

    #@-node:zoomq.20100414115206.4816:hold
    #@+node:zoomq.20100414115206.4817:holdadd
    ...
    #@-node:zoomq.20100414115206.4817:holdadd
    #@+node:zoomq.20100414115206.4818:holdaddsub
    ...
    #@-node:zoomq.20100414115206.4818:holdaddsub
    #@+node:zoomq.20100414115206.4819:holdextend
    ...
    #@-node:zoomq.20100414115206.4819:holdextend
    #@+node:zoomq.20100414115206.4820:blockin
    ...
    #@-node:zoomq.20100414115206.4820:blockin
    #@+node:zoomq.20100414115206.4821:blockout
    def blockout(self):
    ...
    #@-node:zoomq.20100414115206.4821:blockout
    #@+node:zoomq.20100414115206.4822:_last_escapes
    def _last_escapes(self, line):
        return doFinalEscape(TARGET, line)

    #@-node:zoomq.20100414115206.4822:_last_escapes
    #@+node:zoomq.20100414115206.4823:_get_escaped_hold
    ...
    #@-node:zoomq.20100414115206.4823:_get_escaped_hold
    #@+node:zoomq.20100414115206.4824:_remove_twoblanks
    ...
    #@-node:zoomq.20100414115206.4824:_remove_twoblanks
    #@+node:zoomq.20100414115206.4825:tagged
    def tagged(self):
        return self.hold()

    #@-node:zoomq.20100414115206.4825:tagged
    #@+node:zoomq.20100414115206.4826:comment
    def comment(self):
        return ''

    #@-node:zoomq.20100414115206.4826:comment
    #@+node:zoomq.20100414115206.4827:raw
    def raw(self):
        lines = self.hold()
        return map(lambda x: doEscape(TARGET, x), lines)

    #@-node:zoomq.20100414115206.4827:raw
    #@+node:zoomq.20100414115206.4828:para
    def para(self):
        result = []
    ...
    #@-node:zoomq.20100414115206.4828:para
    #@+node:zoomq.20100414115206.4829:verb
    def verb(self):
        ...
        for line in self.hold():
            ...
            result.append(line)
        #@    @+others
        #@+node:zoomq.20100420100426.5116:for SyntaxHighlighter
    ...
    #@-node:zoomq.20100414115206.4829:verb
    #@+node:zoomq.20100414115206.4830:table
    def table(self):
    ...
    #@-node:zoomq.20100414115206.4830:table
    #@+node:zoomq.20100414115206.4831:quote
    def quote(self):
        result = []
        myre   = regex['quote']
    ...
    #@-node:zoomq.20100414115206.4831:quote
    #@+node:zoomq.20100414115206.4832:deflist
    def deflist(self): return self.list('deflist')
    #@-node:zoomq.20100414115206.4832:deflist
    #@+node:zoomq.20100414115206.4833:numlist
    def numlist(self): return self.list('numlist')
    #@-node:zoomq.20100414115206.4833:numlist
    #@+node:zoomq.20100414115206.4834:list
    ...
    #@-others
#@-node:zoomq.20100414115206.4810:class BlockMaster
#@+node:zoomq.20100414115206.4835:class MacroMaster
##############################################################################


class MacroMaster:
    #@    @+others
    #@+node:zoomq.20100414115206.4836:__init__
    ...
    #@-node:zoomq.20100414115206.4836:__init__
    #@+node:zoomq.20100414115206.4837:walk_file_format
    ...
    #@-node:zoomq.20100414115206.4837:walk_file_format
    #@+node:zoomq.20100414115206.4838:expand_file_flag
    ...
    #@-node:zoomq.20100414115206.4838:expand_file_flag
    #@+node:zoomq.20100414115206.4839:set_file_info
    ...
    #@-node:zoomq.20100414115206.4839:set_file_info
    #@+node:zoomq.20100414115206.4840:expand
    ...
    #@-others
#@-node:zoomq.20100414115206.4835:class MacroMaster
#@+node:zoomq.20100414115206.4841:dumpConfig
##############################################################################
...
#@-node:zoomq.20100414115206.4841:dumpConfig
#@+node:zoomq.20100414115206.4842:get_file_body
...
#@-node:zoomq.20100414115206.4842:get_file_body
#@+node:zoomq.20100414115206.4843:finish_him
...
#@-node:zoomq.20100414115206.4843:finish_him
#@+node:zoomq.20100414115206.4844:toc_inside_body
...
#@-node:zoomq.20100414115206.4844:toc_inside_body
#@+node:zoomq.20100414115206.4845:toc_tagger
...
#@-node:zoomq.20100414115206.4845:toc_tagger
#@+node:zoomq.20100414115206.4846:toc_formatter
...
#@-node:zoomq.20100414115206.4846:toc_formatter
#@+node:zoomq.20100414115206.4847:doHeader
...
#@-node:zoomq.20100414115206.4847:doHeader
#@+node:zoomq.20100414115206.4848:doCommentLine
...
#@-node:zoomq.20100414115206.4848:doCommentLine
#@+node:zoomq.20100414115206.4849:doFooter
def doFooter(config):
    if not config['headers']: return []
    ret = []
    target = config['target']
...
#@-node:zoomq.20100414115206.4849:doFooter
#@+node:zoomq.20100414115206.4850:doEscape
...
#@-node:zoomq.20100414115206.4850:doEscape
#@+node:zoomq.20100414115206.4851:doFinalEscape
...
#@-node:zoomq.20100414115206.4851:doFinalEscape
#@+node:zoomq.20100414115206.4852:EscapeCharHandler
...
#@-node:zoomq.20100414115206.4852:EscapeCharHandler
#@+node:zoomq.20100414115206.4853:maskEscapeChar
...
#@-node:zoomq.20100414115206.4853:maskEscapeChar
#@+node:zoomq.20100414115206.4854:unmaskEscapeChar
...
#@-node:zoomq.20100414115206.4854:unmaskEscapeChar
#@+node:zoomq.20100414115206.4855:addLineBreaks
...
#@-node:zoomq.20100414115206.4855:addLineBreaks
#@+node:zoomq.20100414115206.4856:expandLineBreaks
# Convert ['foo\nbar'] to ['foo', 'bar']
...
#@-node:zoomq.20100414115206.4856:expandLineBreaks
#@+node:zoomq.20100414115206.4857:compile_filters
...
#@-node:zoomq.20100414115206.4857:compile_filters
#@+node:zoomq.20100414115206.4858:enclose_me
def enclose_me(tagname, txt):
    return TAGS.get(tagname+'Open') + txt + TAGS.get(tagname+'Close')

#@-node:zoomq.20100414115206.4858:enclose_me
#@+node:zoomq.20100414115206.4859:beautify_me
...
#@-node:zoomq.20100414115206.4859:beautify_me
#@+node:zoomq.20100414115206.4860:get_tagged_link
...
#@-node:zoomq.20100414115206.4860:get_tagged_link
#@+node:zoomq.20100414115206.4861:parse_deflist_term
...
#@-node:zoomq.20100414115206.4861:parse_deflist_term
#@+node:zoomq.20100414115206.4862:get_tagged_bar
...
#@-node:zoomq.20100414115206.4862:get_tagged_bar
#@+node:zoomq.20100414115206.4863:get_image_align
...
#@-node:zoomq.20100414115206.4863:get_image_align
#@+node:zoomq.20100414115206.4864:get_encoding_string
...
#@-node:zoomq.20100414115206.4864:get_encoding_string
#@+node:zoomq.20100414115206.4865:process_source_file
##############################################################################
...
#@-node:zoomq.20100414115206.4865:process_source_file
#@+node:zoomq.20100414115206.4866:get_infiles_config
...
#@-node:zoomq.20100414115206.4866:get_infiles_config
#@+node:zoomq.20100414115206.4867:convert_this_files
...
#@-node:zoomq.20100414115206.4867:convert_this_files
#@+node:zoomq.20100414115206.4868:parse_images
...
#@-node:zoomq.20100414115206.4868:parse_images
#@+node:zoomq.20100414115206.4869:add_inline_tags
...
#@-node:zoomq.20100414115206.4869:add_inline_tags
#@+node:zoomq.20100414115206.4870:get_include_contents
...
#@-node:zoomq.20100414115206.4870:get_include_contents
#@+node:zoomq.20100414115206.4871:set_global_config
...
#@-node:zoomq.20100414115206.4871:set_global_config
#@+node:zoomq.20100414115206.4872:convert
...
#@-node:zoomq.20100414115206.4872:convert
#@+node:zoomq.20100414115206.4873:load_GUI_resources
##############################################################################
################################### GUI ######################################
##############################################################################
#
...
#@-node:zoomq.20100414115206.4873:load_GUI_resources
#@+node:zoomq.20100414115206.4874:class Gui
class Gui:
    "Graphical Tk Interface"
    #@    @+others
    #@+node:zoomq.20100414115206.4875:__init__
    ...
    #@-node:zoomq.20100414115206.4875:__init__
    #@+node:zoomq.20100414115206.4876:load_config
    ...
    #@-node:zoomq.20100414115206.4884:frame_close
    #@+node:zoomq.20100414115206.4885:target_name2key
    ...
    #@-node:zoomq.20100414115206.4885:target_name2key
    #@+node:zoomq.20100414115206.4886:target_key2name
    ...
    #@-node:zoomq.20100414115206.4886:target_key2name
    #@+node:zoomq.20100414115206.4887:exit
    def exit(self): self.root.destroy()
    #@-node:zoomq.20100414115206.4887:exit
    #@+node:zoomq.20100414115206.4888:setvar
    def setvar(self, val): z = Tkinter.StringVar() ; z.set(val) ; return z

    #@-node:zoomq.20100414115206.4888:setvar
    #@+node:zoomq.20100414115206.4889:askfile
    def askfile(self):
    ...
    #@-node:zoomq.20100414115206.4889:askfile
    #@+node:zoomq.20100414115206.4890:scrollwindow
    ...
    #@-node:zoomq.20100414115206.4890:scrollwindow
    #@+node:zoomq.20100414115206.4891:runprogram
    def runprogram(self):
        global CMDLINE_RAW
        # Prepare
    ...
    #@-node:zoomq.20100414115206.4891:runprogram
    #@+node:zoomq.20100414115206.4892:mainwindow
    def mainwindow(self):
    ...
    #@-others
#@-node:zoomq.20100414115206.4874:class Gui
#@+node:zoomq.20100414115206.4893:exec_command_line
##############################################################################
##############################################################################
